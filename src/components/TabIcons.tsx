...
export const HomeIcon = ({ color, size = 20 }: TabIconProps) => (
...
export const MissionsIcon = ({ color, size = 20 }: TabIconProps) => (
...
export const GoalsIcon = ({ color, size = 20 }: TabIconProps) => (
...
export const ExperiencesIcon = ({ color, size = 20 }: TabIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 25 24" fill="none">
    <Path 
...
export const MenuIcon = ({ color, size = 20 }: TabIconProps) => (
