...
export const NotificationIcon = ({ size = 24 }: NotificationIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path 
      d="M10.2695 21C10.4451 21.304 10.6975 21.5565 11.0016 21.732C11.3056 21.9075 11.6505 21.9999 12.0015 21.9999C12.3526 21.9999 12.6975 21.9075 13.0015 21.732C13.3055 21.5565 13.558 21.304 13.7335 21" 
      stroke="white" 
      strokeWidth="2" 
      strokeLinecap="round" 
...
export default function NotificationBtn({ onPress, size = 24 }: NotificationBtnProps) {
  return (
